Feature: add non-public editor notes to a video

  As an editor
  I want to have a "Notes" field of the video I am editting
...
Scenario: make sure the field is present
  ...
  When  I go to the edit video page for "TestVideo"
...
Scenario: disallow public users from seeing the notes
  ...
  And I go to the show video page for "TestVideo"
